...
FIRST_REMOTE_CKPT_DIR=${ETPR1_BEST_SFT_GRPO_FIRST_REMOTE_CKPT_DIR:-${REMOTE_REPO}/data/logs/rae_dinov2_etpnav_cls_768/r2r_sft_legacy452500_nonvisual_20260815/checkpoints/rae_dinov2_etpnav_cls_768_legacy452500_nonvisual_r2r_sft}
