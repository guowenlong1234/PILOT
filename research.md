...
2026-09-20用户新增9200对照：部署基座改为9200，仍复用6400数据训练的4750评分头×1.5；新增显式`6400_to_9200`合同，原6400数据和权重校验不放宽。计划在测评机按相同配置重新跑9200基线及9200＋E24各1839路线，先做本轮重复基线/零倍率短测。见`docs/stage2-online-9200-navigation-20260920.md`。
