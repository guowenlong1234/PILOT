...
_C.MODEL.RAENWM.token_count = 256
...
_C.MODEL.RAENWM.panorama_context_mode = "auto"
_C.MODEL.RAENWM.panorama_encode_batch_size = 16
_C.MODEL.RAENWM.panorama_prediction_batch_size = 8
_C.MODEL.RAENWM.panorama_cached_views_per_frame = 12
_C.MODEL.RAENWM.panorama_observation_source = "cube"
_C.MODEL.RAENWM.panorama_visual_precision = "float32"
_C.MODEL.RAENWM.torch_compile = False
_C.MODEL.RAENWM.compile_backend = "inductor"
...
_C.MODEL.ACTIVE_LOOKAHEAD.base_selection_manifest_sha256 = ""
...
_C.MODEL.ACTIVE_LOOKAHEAD.top5_cls_lr = 1.0e-5
_C.MODEL.ACTIVE_LOOKAHEAD.top5_cls_weight_decay = 0.01
_C.MODEL.ACTIVE_LOOKAHEAD.top5_cls_gradient_clip_norm = 10.0
_C.MODEL.ACTIVE_LOOKAHEAD.e24_head_weight_decay = 0.01
