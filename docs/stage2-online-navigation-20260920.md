...
**历史基线补充：** 本轮62.86%使用持久组6400的同一权重，但其训练机历史SR/SPL是63.6215%/55.2559%；9200历史SR更高，为64.0566%。本轮尚未复现历史6400成绩，下降原因未作单因素定位；本轮提升只能解释为当前协议内的成对增益，不能称为超过历史最佳。详见[基线身份核对](stage2-baseline-identity-review-20260920.md)。
